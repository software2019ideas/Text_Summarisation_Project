...
public class ClueWords_Neg {
    ...
    public static void main(String [] args){
        try {
         ...
         BufferedReader br1 = new BufferedReader(new FileReader("PUT YOUR PATH HERE\\Arsenal 4-1 Fulham Hosts start New Year with victory to close gap on top four(Tue 1st January).txt"));
